...
namespace Ferreteria_MVC.Controllers
{
    public class VentasController : Controller
    {
        ...
        {
            ViewBag.idEmpleado = new SelectList(db.Empleado, "IdEmpleado", "Descripcion");
        ...
        public ActionResult Create([Bind(Include = "IdVenta,Descripcion,fecha,idPersona,idEmpleado")] Ventas ventas)
        {
            ...
            ViewBag.idEmpleado = new SelectList(db.Empleado, "IdEmpleado", "Descripcion", ventas.idEmpleado);
            ViewBag.idPersona = new SelectList(db.Persona, "IdPersona", "nombre", ventas.idPersona);
            return View(ventas);
        }
