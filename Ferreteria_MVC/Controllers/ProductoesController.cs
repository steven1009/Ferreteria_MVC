...
namespace Ferreteria_MVC.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdProducto,Nombre,PrecioU,IdCategoria")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdProducto,Nombre,PrecioU,IdCategoria")] Producto producto)
        {
            if (ModelState.IsValid)
            {
